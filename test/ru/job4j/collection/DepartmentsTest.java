...
public class DepartmentsTest {
  ...
  public void whenMissedNew() {
    List<String> input = Arrays.asList("k2/sk1/sk2", "k1/sk1");
    List<String> expect = Arrays.asList("k2", "k2/sk1", "k2/sk1/sk2", "k1", "k1/sk1");
    List<String> result = Departments.fillGaps(input);
    assertThat(result, is(expect));
  }
  ...
  public void sortDscBig() {
    ...
    List<String> expect = Arrays
        .asList("K2", "K2/SK1", "K2/SK1/SSK1", "K2/SK1/SSK2", "K1", "K1/SK1",
